...
function PizzaItem({ pizza }) {
  ...
  return (
    <div className="bg-orange-100 rounded-2xl shadow-lg overflow-hidden hover:transform hover:scale-105 transition-transform duration-500 ease-in-out">
      <img
        src={pizza.imageUrl}
        alt={pizza.name}
      ...
      <div className="p-4 flex flex-col justify-between items-start">
        ...
        <div className="flex justify-between items-center w-full space-x-2 mt-2">
          ...
          <div className="flex justify-between items-center space-x-2">
            <button className="text-red-500" onClick={handleDecrement}>
              <FaMinus />
            </button>
            <p>Qty: {qty}</p>
            <button className="text-green-500" onClick={handleIncrement}>
              <FaPlus />
            </button>
          </div>
        </div>
